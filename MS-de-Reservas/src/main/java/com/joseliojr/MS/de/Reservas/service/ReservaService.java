package com.joseliojr.MS.de.Reservas.service;

import com.joseliojr.MS.de.Reservas.dto.ReservaRequest;
import com.joseliojr.MS.de.Reservas.dto.ReservaResponse;
import com.joseliojr.MS.de.Reservas.enums.StatusReserva;
import com.joseliojr.MS.de.Reservas.exception.BusinessException;
import com.joseliojr.MS.de.Reservas.exception.ResourceNotFoundException;
import com.joseliojr.MS.de.Reservas.exception.ServiceCommunicationException;
import com.joseliojr.MS.de.Reservas.model.Reserva;
import com.joseliojr.MS.de.Reservas.repository.ReservaRepository;
...
public class ReservaService {
    ...
    private void verificarDisponibilidadeVoo(Long vooId) {
        try {
            Boolean disponivel = webClientBuilder.build()
                    .get()
            ...
            if (disponivel == null || !disponivel) {
                throw new BusinessException("Voo não disponível ou não encontrado");
            }
        } catch (Exception e) {
            throw new ServiceCommunicationException("Erro ao comunicar com o serviço de voos", e);
        }
    }
    ...
    private void verificarDisponibilidadeHotel(Long hotelId) {
        try {
            ...
            if (disponivel == null || !disponivel) {
                throw new BusinessException("Hotel não disponível ou não encontrado");
            }
        } catch (Exception e) {
            throw new ServiceCommunicationException("Erro ao comunicar com o serviço de hotéis", e);
        }
    }
}
